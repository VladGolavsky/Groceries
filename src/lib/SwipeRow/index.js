...
class SwipeRow extends Component {
    constructor(props) {
        super(props);
        // this.isOpen = true;
        this.isOpen = this.props.shoudBeOpened ? true : false;
        ...
        this._translateX = new Animated.Value(this.props.shoudBeOpened ? this.props.leftOpenValue : 0);
    ...
    openRowWithoutAnimation() {
        this._translateX.setValue(this.props.leftOpenValue);
        this.isOpen = true;
    }
